...
public class Q2EmitTweetSpout extends BaseRichSpout {
	...
	public Q2EmitTweetSpout(String consumerKey, String consumerSecret,
	...
	public void open(Map conf, TopologyContext context,
		...
		if (keyWords.length == 0) {
			...
			FilterQuery query = new FilterQuery().track(keyWords).language(langs);
